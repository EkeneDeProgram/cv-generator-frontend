...
//   // Memoize the CV slice to prevent new references on every render
...
//   // Watch and debounce work experience
//   const watchedWork = watch("workExperience");
//   const debouncedWork = useDebounce(watchedWork, 500);

//   // Auto-save whenever debounced work experience changes
//   useEffect(() => {
//     setIsSaving(true);
...
//           onClick={() => append({ id: uuidv4(), company: "", role: "", startDate: "", description: "" })}
//         >
//           Add Work
//         </button>

//         <button type="button" style={primaryButtonStyle} disabled={isSaving}>
